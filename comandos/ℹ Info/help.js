        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setImage('https://imgur.com/F8FU6TJ.png')
            ...
            .setColor("#4EF5BD")
            .setDescription(`Sistema de ayuda de \`Graphic Design Division\``)
            .addFields([{name: `ℹ **__¿Quienes somos?__**`, value: `Hola **${message.author.username}**, somos los pertenecientes a la __**Graphic Design Division**__, división la cual forman parte diseñadores, fotógrafos, filmmakers, editores, y mucho más, encargados del contenido visual y audiovisual que puedas apreciar de la LSPD en carácter público.`}], )
            .setThumbnail('https://imgur.com/sjQTlh9.png')
            .setImage('https://imgur.com/F8FU6TJ.png')
            .setFooter({ text: 'Powered By Welben', iconURL: 'https://imgur.com/TsKFaHl.png' })
